...
(* OASIS_START *)
(* DO NOT EDIT (digest: 3b0663241e3229c7f86aa7fdc4f4db97) *)
(*
...
(* # 21 "/home/djs/.opam/4.00.1/build/oasis.0.3.0/src/plugins/custom/CustomPlugin.ml" *)
...
let setup_t =
  {
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "'\243\194\030\165i\136\246\242y,\014\153`o\187";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
