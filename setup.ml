...
(* OASIS_START *)
(* DO NOT EDIT (digest: a5b91baefb7f9c21a7c0d74267f2e787) *)
(*
...
(* # 21 "/home/avsm/.opam/4.00.1+mirage-xen/build/oasis.0.3.0/src/plugins/custom/CustomPlugin.ml" *)
...
let setup_t =
  {
     ...
     oasis_version = "0.3.0";
     oasis_digest =
       Some "Z\171\133\196\016\200\022\016\181J\136\028\253\164>y";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
