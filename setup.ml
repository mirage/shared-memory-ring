...
(* OASIS_START *)
(* DO NOT EDIT (digest: 932eee512a796b033a28dae2a34e6a9e) *)
(*
...
(* # 21 "/local/scratch/djs/.opam/system/build/oasis.0.3.0/src/plugins/custom/CustomPlugin.ml" *)
...
let setup_t =
  {
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "//\187f\151)\157\196\160v\161L\250L\247\139";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
